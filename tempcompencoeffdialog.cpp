...
//    quint32 ZGyroTempCompenCoeff3uint32 =*(quint32 *)&ZGyroTempCompenCoeff3f;
    ...
    QString bookDataStr = tr("装订陀螺温补系数：") + tr("X陀螺零偏温度0次项=")+ QString::number(XGyroTempCompenCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" Y陀螺零偏温度0次项=")+ QString::number(YGyroTempCompenCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" Z陀螺零偏温度0次项=")+ QString::number(ZGyroTempCompenCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" X陀螺零偏温度1次项=")+ QString::number(XGyroTempCompenCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" Y陀螺零偏温度1次项=")+ QString::number(YGyroTempCompenCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" Z陀螺零偏温度1次项=")+ QString::number(ZGyroTempCompenCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" X陀螺零偏温度2次项=")+ QString::number(XGyroTempCompenCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" Y陀螺零偏温度2次项=")+ QString::number(YGyroTempCompenCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" Z陀螺零偏温度2次项=")+ QString::number(ZGyroTempCompenCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" X陀螺零偏温度3次项=")+ QString::number(XGyroTempCompenCoeff3FloatStr.toFloat (),'f',4)
                                                + tr(" Y陀螺零偏温度3次项=")+ QString::number(YGyroTempCompenCoeff3FloatStr.toFloat (),'f',4)
                                                + tr(" Z陀螺零偏温度3次项=")+ QString::number(ZGyroTempCompenCoeff3FloatStr.toFloat (),'f',4)
                                                +"\n";
...
//    quint32 ZAccelerometerComCoeff3uint32 =*(quint32 *)&ZAccelerometerComCoeff3f;
    ...
    QString dateStr =current_date_time.toString("[yyyy-MM-dd hh:mm:ss]");
    QString dateTimeStr = dateStr + "\n";
    QString bookDataStr = tr("装订加速度计温补系数：") + tr("X加速度计零偏温度0次项=")+ QString::number(XAccelerometerComCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" Y加速度计零偏温度0次项=")+ QString::number(YAccelerometerComCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" Z加速度计零偏温度0次项=")+ QString::number(ZAccelerometerComCoeff0FloatStr.toFloat (),'f',4)
                                                + tr(" X加速度计零偏温度1次项=")+ QString::number(XAccelerometerComCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" Y加速度计零偏温度1次项=")+ QString::number(YAccelerometerComCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" Z加速度计零偏温度1次项=")+ QString::number(ZAccelerometerComCoeff1FloatStr.toFloat (),'f',4)
                                                + tr(" X加速度计零偏温度2次项=")+ QString::number(XAccelerometerComCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" Y加速度计零偏温度2次项=")+ QString::number(YAccelerometerComCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" Z加速度计零偏温度2次项=")+ QString::number(ZAccelerometerComCoeff2FloatStr.toFloat (),'f',4)
                                                + tr(" X加速度计零偏温度3次项=")+ QString::number(XAccelerometerComCoeff3FloatStr.toFloat (),'f',4)
                                                + tr(" Y加速度计零偏温度3次项=")+ QString::number(YAccelerometerComCoeff3FloatStr.toFloat (),'f',4)
                                                + tr(" Z加速度计零偏温度3次项=")+ QString::number(ZAccelerometerComCoeff3FloatStr.toFloat (),'f',4)
                                                +"\n";
    QString sendBookDataStr = dateTimeStr+bookDataStr;
    emit bookLogCMD(sendBookDataStr);
