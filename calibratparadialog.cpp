...
void CalibratParaDialog::on_pushButton_clicked()
{
    ...
    QString  SdataStr= "EB 90 07 ";
     ...
     QString bookDataStr = tr("装订陀螺标定参数：") + tr("X陀螺标度=")+QString::number(XGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺标度=")+ QString::number(YGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺标度=")+ QString::number(ZGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" X陀螺常漂=")+ QString::number(XZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺常漂=")+ QString::number(YZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺常漂=")+ QString::number(ZZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uxy=")+ QString::number(XGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uxz=")+ QString::number(UGXZGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uyx=")+ QString::number(YGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uyz=")+ QString::number(UGYZGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uzx=")+ QString::number(ZGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 陀螺安装误差Uzy=")+ QString::number(UGZYGyroInstalErrorFloatStr.toDouble(),'f',4)+"\n";
...
void CalibratParaDialog::on_pushButton_2_clicked()
{
    ...
    QString  SdataStr= "EB 90 08 ";
     ...
     QString dateStr =current_date_time.toString("[yyyy-MM-dd hh:mm:ss]");
     QString dateTimeStr = dateStr + "\n";
     QString bookDataStr = tr("装订加速度计标定参数：") + tr("X加速度计标度=")+ QString::number(XAccelerometerScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计标度=")+ QString::number(YAccelerometerScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计标度=")+ QString::number(ZAccelerometerScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" X加速度计常漂=")+ QString::number(XAccelerometerZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计常漂=")+ QString::number(YAccelerometerZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计常漂=")+ QString::number(ZAccelerometerZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uxy=")+ QString::number(XAccelerometerInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uxz=")+ QString::number(UGXZAccelerometerInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uyx=")+ QString::number(YAccelerometerInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uyz=")+ QString::number(UGYZAccelerometerInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uzx=")+ QString::number(ZAccelerometerInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加速度计安装误差Uzy=")+ QString::number(UGZYAccelerometerInstalErrorFloatStr.toDouble(),'f',4)+"\n";
     QString sendBookDataStr = dateTimeStr+bookDataStr;
     emit bookLogCMD(sendBookDataStr);
...
void CalibratParaDialog::on_pushButton_3_clicked()
{
    ...
    QString  SdataStr= "EB 90 09 "+XGyroEqZeroBiasdataStr+YGyroEqZeroBiasdataStr+ZGyroEqZeroBiasdataStr+SdataCheckSumHexStr;
     ...
     QString dateStr =current_date_time.toString("[yyyy-MM-dd hh:mm:ss]");
     QString dateTimeStr = dateStr + "\n";
     QString bookDataStr = tr("装订陀螺等效零偏：") + tr("X陀螺等效零偏=")+ QString::number(XGyroEqZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺等效零偏=")+ QString::number(YGyroEqZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺等效零偏=")+ QString::number(ZGyroEqZeroBiasFloatStr.toDouble(),'f',4)+"\n";
     QString sendBookDataStr = dateTimeStr+bookDataStr;
     emit bookLogCMD(sendBookDataStr);
...
void CalibratParaDialog::on_pushButton_7_clicked()
{
    QByteArray Sdata;

    QString XGyroScaleFloatStr = ui->lineEdit_52->text();
    double XGyroScalef = XGyroScaleFloatStr.toDouble() * qPow(10,8);
    quint32 XGyroScaleuint32 = qRound64(XGyroScalef);
    QString XGyroScalefloat_str = QString::number(XGyroScaleuint32,16);
    QString XGyroScalefloat_hex = XGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString YGyroScaleFloatStr = ui->lineEdit_53->text();
    double YGyroScalef = YGyroScaleFloatStr.toDouble() * qPow(10,8);
    quint32 YGyroScaleuint32 = qRound64(YGyroScalef);
    QString YGyroScalefloat_str = QString::number(YGyroScaleuint32,16);
    QString YGyroScalefloat_hex = YGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString ZGyroScaleFloatStr = ui->lineEdit_54->text();
    double ZGyroScalef = ZGyroScaleFloatStr.toDouble() * qPow(10,8);
    quint32 ZGyroScaleuint32 = qRound64(ZGyroScalef);
    QString ZGyroScalefloat_str = QString::number(ZGyroScaleuint32,16);
    QString ZGyroScalefloat_hex = ZGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString XZeroBiasFloatStr = ui->lineEdit_55->text();
    double XZeroBiasf = XZeroBiasFloatStr.toDouble() * qPow(10,8);
    quint32 XZeroBiasuint32 = qRound64(XZeroBiasf);
    QString XZeroBiasfloat_str = QString::number(XZeroBiasuint32,16);
    QString XZeroBiasfloat_hex = XZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString XZeroBiasdataStr = XZeroBiasfloat_hex.mid(6,2)+" "+XZeroBiasfloat_hex.mid(4,2)+" "+XZeroBiasfloat_hex.mid(2,2)+" "+XZeroBiasfloat_hex.mid(0,2)+" ";
    ...
    QString YZeroBiasFloatStr = ui->lineEdit_57->text();
    double YZeroBiasf = YZeroBiasFloatStr.toDouble() * qPow(10,8);
    quint32 YZeroBiasuint32 = qRound64(YZeroBiasf);
    QString YZeroBiasfloat_str = QString::number(YZeroBiasuint32,16);
    QString YZeroBiasfloat_hex = YZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString YZeroBiasdataStr = YZeroBiasfloat_hex.mid(6,2)+" "+YZeroBiasfloat_hex.mid(4,2)+" "+YZeroBiasfloat_hex.mid(2,2)+" "+YZeroBiasfloat_hex.mid(0,2)+" ";
    ...
    QString ZZeroBiasFloatStr = ui->lineEdit_59->text();
    double ZZeroBiasf = ZZeroBiasFloatStr.toDouble() * qPow(10,8);
    quint32 ZZeroBiasuint32 = qRound64(ZZeroBiasf);
    QString ZZeroBiasfloat_str = QString::number(ZZeroBiasuint32,16);
    QString ZZeroBiasfloat_hex = ZZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString ZZeroBiasdataStr = ZZeroBiasfloat_hex.mid(6,2)+" "+ZZeroBiasfloat_hex.mid(4,2)+" "+ZZeroBiasfloat_hex.mid(2,2)+" "+ZZeroBiasfloat_hex.mid(0,2)+" ";
    ...
    QString XGyroInstalErrorFloatStr = ui->lineEdit_56->text();
    double XGyroInstalErrorf = XGyroInstalErrorFloatStr.toDouble() * qPow(10,8);
    quint32 XGyroInstalErroruint32 = qRound64(XGyroInstalErrorf);
    QString XGyroInstalErrorfloat_str = QString::number(XGyroInstalErroruint32,16);
    QString XGyroInstalErrorfloat_hex = XGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString XGyroInstalErrordataStr = XGyroInstalErrorfloat_hex.mid(6,2)+" "+XGyroInstalErrorfloat_hex.mid(4,2)+" "+XGyroInstalErrorfloat_hex.mid(2,2)+" "+XGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    QString YGyroInstalErrorFloatStr = ui->lineEdit_58->text();
    double YGyroInstalErrorf = YGyroInstalErrorFloatStr.toDouble() * qPow(10,8);
    quint32 YGyroInstalErroruint32 = qRound64(YGyroInstalErrorf);
    QString YGyroInstalErrorfloat_str = QString::number(YGyroInstalErroruint32,16);
    QString YGyroInstalErrorfloat_hex = YGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString YGyroInstalErrordataStr = YGyroInstalErrorfloat_hex.mid(6,2)+" "+YGyroInstalErrorfloat_hex.mid(4,2)+" "+YGyroInstalErrorfloat_hex.mid(2,2)+" "+YGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    QString ZGyroInstalErrorFloatStr = ui->lineEdit_60->text();
    double ZGyroInstalErrorf = ZGyroInstalErrorFloatStr.toDouble() * qPow(10,8);
    quint32 ZGyroInstalErroruint32 = qRound64(ZGyroInstalErrorf);
    QString ZGyroInstalErrorfloat_str = QString::number(ZGyroInstalErroruint32,16);
    QString ZGyroInstalErrorfloat_hex = ZGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString ZGyroInstalErrordataStr = ZGyroInstalErrorfloat_hex.mid(6,2)+" "+ZGyroInstalErrorfloat_hex.mid(4,2)+" "+ZGyroInstalErrorfloat_hex.mid(2,2)+" "+ZGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    int SdataCheckSum = XGyroScaleCheckSumInt +YGyroScaleCheckSumInt+ ZGyroScaleCheckSumInt+XZeroBiasCheckSumInt+ YZeroBiasCheckSumInt+ZZeroBiasCheckSumInt+XGyroInstalErrorCheckSumInt+YGyroInstalErrorCheckSumInt+ZGyroInstalErrorCheckSumInt+19;
    QString SdataCheckSumHexStr= QString::number(SdataCheckSum,16).right(2);


    QString  SdataStr= "EB 90 13 "+XGyroScaledataStr+YGyroScaledataStr+ZGyroScaledataStr+XZeroBiasdataStr+YZeroBiasdataStr+ZZeroBiasdataStr+XGyroInstalErrordataStr+YGyroInstalErrordataStr+ZGyroInstalErrordataStr+SdataCheckSumHexStr;
     ...
     QString dateStr =current_date_time.toString("[yyyy-MM-dd hh:mm:ss]");
     QString dateTimeStr = dateStr + "\n";
     QString bookDataStr = tr("装订陀螺标定参数2：") + tr("X陀螺名义标度=")+QString::number(XGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺名义标度=")+ QString::number(YGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺名义标度=")+ QString::number(ZGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" X陀螺序号=")+ QString::number(XZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺序号=")+ QString::number(YZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺序号=")+ QString::number(ZZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" X陀螺符号=")+ QString::number(XGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" Y陀螺符号=")+ QString::number(YGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" Z陀螺符号=")+ QString::number(ZGyroInstalErrorFloatStr.toDouble(),'f',4)+"\n";
     QString sendBookDataStr = dateTimeStr+bookDataStr;
     emit bookLogCMD(sendBookDataStr);
...
void CalibratParaDialog::on_pushButton_8_clicked()
{
    QByteArray Sdata;

    QString XGyroScaleFloatStr = ui->lineEdit_61->text();
    double XGyroScalef = XGyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 XGyroScaleuint32 = qRound64(XGyroScalef);
    QString XGyroScalefloat_str = QString::number(XGyroScaleuint32,16);
    QString XGyroScalefloat_hex = XGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString YGyroScaleFloatStr = ui->lineEdit_62->text();
    double YGyroScalef = YGyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 YGyroScaleuint32 = qRound64(YGyroScalef);
    QString YGyroScalefloat_str = QString::number(YGyroScaleuint32,16);
    QString YGyroScalefloat_hex = YGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    QString YGyroScaledataStr = YGyroScalefloat_hex.mid(6,2)+" "+YGyroScalefloat_hex.mid(4,2)+" "+YGyroScalefloat_hex.mid(2,2)+" "+YGyroScalefloat_hex.mid(0,2)+" ";
    ...
    QString ZGyroScaleFloatStr = ui->lineEdit_63->text();
    double ZGyroScalef = ZGyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 ZGyroScaleuint32 = qRound64(ZGyroScalef);
    QString ZGyroScalefloat_str = QString::number(ZGyroScaleuint32,16);
    QString ZGyroScalefloat_hex = ZGyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    QString ZGyroScaledataStr = ZGyroScalefloat_hex.mid(6,2)+" "+ZGyroScalefloat_hex.mid(4,2)+" "+ZGyroScalefloat_hex.mid(2,2)+" "+ZGyroScalefloat_hex.mid(0,2)+" ";
    ...
    QString XZeroBiasFloatStr = ui->lineEdit_67->text();
    double XZeroBiasf = XZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 XZeroBiasuint32 = qRound64(XZeroBiasf);
    QString XZeroBiasfloat_str = QString::number(XZeroBiasuint32,16);
    QString XZeroBiasfloat_hex = XZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString YZeroBiasFloatStr = ui->lineEdit_69->text();
    double YZeroBiasf = YZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 YZeroBiasuint32 = qRound64(YZeroBiasf);
    QString YZeroBiasfloat_str = QString::number(YZeroBiasuint32,16);
    QString YZeroBiasfloat_hex = YZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString ZZeroBiasFloatStr = ui->lineEdit_71->text();
    double ZZeroBiasf = ZZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 ZZeroBiasuint32 = qRound64(ZZeroBiasf);
    QString ZZeroBiasfloat_str = QString::number(ZZeroBiasuint32,16);
    QString ZZeroBiasfloat_hex = ZZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    ...
    QString XGyroInstalErrorFloatStr = ui->lineEdit_64->text();
    double XGyroInstalErrorf = XGyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 XGyroInstalErroruint32 = qRound64(XGyroInstalErrorf);
    QString XGyroInstalErrorfloat_str = QString::number(XGyroInstalErroruint32,16);
    QString XGyroInstalErrorfloat_hex = XGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString XGyroInstalErrordataStr = XGyroInstalErrorfloat_hex.mid(6,2)+" "+XGyroInstalErrorfloat_hex.mid(4,2)+" "+XGyroInstalErrorfloat_hex.mid(2,2)+" "+XGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    QString YGyroInstalErrorFloatStr = ui->lineEdit_65->text();
    double YGyroInstalErrorf = YGyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 YGyroInstalErroruint32 = qRound64(YGyroInstalErrorf);
    QString YGyroInstalErrorfloat_str = QString::number(YGyroInstalErroruint32,16);
    QString YGyroInstalErrorfloat_hex = YGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString YGyroInstalErrordataStr = YGyroInstalErrorfloat_hex.mid(6,2)+" "+YGyroInstalErrorfloat_hex.mid(4,2)+" "+YGyroInstalErrorfloat_hex.mid(2,2)+" "+YGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    QString ZGyroInstalErrorFloatStr = ui->lineEdit_66->text();
    double ZGyroInstalErrorf = ZGyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 ZGyroInstalErroruint32 = qRound64(ZGyroInstalErrorf);
    QString ZGyroInstalErrorfloat_str = QString::number(ZGyroInstalErroruint32,16);
    QString ZGyroInstalErrorfloat_hex = ZGyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString ZGyroInstalErrordataStr = ZGyroInstalErrorfloat_hex.mid(6,2)+" "+ZGyroInstalErrorfloat_hex.mid(4,2)+" "+ZGyroInstalErrorfloat_hex.mid(2,2)+" "+ZGyroInstalErrorfloat_hex.mid(0,2)+" ";
    ...
    QString X2GyroScaleFloatStr = ui->lineEdit_70->text();
    double X2GyroScalef = X2GyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 X2GyroScaleuint32 = qRound64(X2GyroScalef);
    QString X2GyroScalefloat_str = QString::number(X2GyroScaleuint32,16);
    QString X2GyroScalefloat_hex = X2GyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    QString X2GyroScaledataStr = X2GyroScalefloat_hex.mid(6,2)+" "+X2GyroScalefloat_hex.mid(4,2)+" "+X2GyroScalefloat_hex.mid(2,2)+" "+X2GyroScalefloat_hex.mid(0,2)+" ";
    int X2GyroScaleCheckSumInt = X2GyroScalefloat_hex.mid(6,2).toInt(nullptr,16) + X2GyroScalefloat_hex.mid(4,2).toInt(nullptr,16)+X2GyroScalefloat_hex.mid(2,2).toInt(nullptr,16)+X2GyroScalefloat_hex.mid(0,2).toInt(nullptr,16);


    QString Y2GyroScaleFloatStr = ui->lineEdit_72->text();
    double Y2GyroScalef = Y2GyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 Y2GyroScaleuint32 = qRound64(Y2GyroScalef);
    QString Y2GyroScalefloat_str = QString::number(Y2GyroScaleuint32,16);
    QString Y2GyroScalefloat_hex = Y2GyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    QString Y2GyroScaledataStr = Y2GyroScalefloat_hex.mid(6,2)+" "+Y2GyroScalefloat_hex.mid(4,2)+" "+Y2GyroScalefloat_hex.mid(2,2)+" "+Y2GyroScalefloat_hex.mid(0,2)+" ";
    int Y2GyroScaleCheckSumInt = Y2GyroScalefloat_hex.mid(6,2).toInt(nullptr,16) + Y2GyroScalefloat_hex.mid(4,2).toInt(nullptr,16)+Y2GyroScalefloat_hex.mid(2,2).toInt(nullptr,16)+Y2GyroScalefloat_hex.mid(0,2).toInt(nullptr,16);

    QString Z2GyroScaleFloatStr = ui->lineEdit_68->text();
    double Z2GyroScalef = Z2GyroScaleFloatStr.toDouble() * qPow(10,6);
    quint32 Z2GyroScaleuint32 = qRound64(Z2GyroScalef);
    QString Z2GyroScalefloat_str = QString::number(Z2GyroScaleuint32,16);
    QString Z2GyroScalefloat_hex = Z2GyroScalefloat_str.rightJustified(8,QLatin1Char('0'));
    QString Z2GyroScaledataStr = Z2GyroScalefloat_hex.mid(6,2)+" "+Z2GyroScalefloat_hex.mid(4,2)+" "+Z2GyroScalefloat_hex.mid(2,2)+" "+Z2GyroScalefloat_hex.mid(0,2)+" ";
    int Z2GyroScaleCheckSumInt = Z2GyroScalefloat_hex.mid(6,2).toInt(nullptr,16) + Z2GyroScalefloat_hex.mid(4,2).toInt(nullptr,16)+Z2GyroScalefloat_hex.mid(2,2).toInt(nullptr,16)+Z2GyroScalefloat_hex.mid(0,2).toInt(nullptr,16);

    QString X2ZeroBiasFloatStr = ui->lineEdit_75->text();
    double X2ZeroBiasf = X2ZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 X2ZeroBiasuint32 = qRound64(X2ZeroBiasf);
    QString X2ZeroBiasfloat_str = QString::number(X2ZeroBiasuint32,16);
    QString X2ZeroBiasfloat_hex = X2ZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString X2ZeroBiasdataStr = X2ZeroBiasfloat_hex.mid(6,2)+" "+X2ZeroBiasfloat_hex.mid(4,2)+" "+X2ZeroBiasfloat_hex.mid(2,2)+" "+X2ZeroBiasfloat_hex.mid(0,2)+" ";
    int X2ZeroBiasCheckSumInt = X2ZeroBiasfloat_hex.mid(6,2).toInt(nullptr,16) + X2ZeroBiasfloat_hex.mid(4,2).toInt(nullptr,16)+X2ZeroBiasfloat_hex.mid(2,2).toInt(nullptr,16)+X2ZeroBiasfloat_hex.mid(0,2).toInt(nullptr,16);

    QString Y2ZeroBiasFloatStr = ui->lineEdit_74->text();
    double Y2ZeroBiasf = Y2ZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 Y2ZeroBiasuint32 = qRound64(Y2ZeroBiasf);
    QString Y2ZeroBiasfloat_str = QString::number(Y2ZeroBiasuint32,16);
    QString Y2ZeroBiasfloat_hex = Y2ZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString Y2ZeroBiasdataStr = Y2ZeroBiasfloat_hex.mid(6,2)+" "+Y2ZeroBiasfloat_hex.mid(4,2)+" "+Y2ZeroBiasfloat_hex.mid(2,2)+" "+Y2ZeroBiasfloat_hex.mid(0,2)+" ";
    int Y2ZeroBiasCheckSumInt = Y2ZeroBiasfloat_hex.mid(6,2).toInt(nullptr,16) + Y2ZeroBiasfloat_hex.mid(4,2).toInt(nullptr,16)+Y2ZeroBiasfloat_hex.mid(2,2).toInt(nullptr,16)+Y2ZeroBiasfloat_hex.mid(0,2).toInt(nullptr,16);

    QString Z2ZeroBiasFloatStr = ui->lineEdit_73->text();
    double Z2ZeroBiasf = Z2ZeroBiasFloatStr.toDouble() * qPow(10,6);
    quint32 Z2ZeroBiasuint32 = qRound64(Z2ZeroBiasf);
    QString Z2ZeroBiasfloat_str = QString::number(Z2ZeroBiasuint32,16);
    QString Z2ZeroBiasfloat_hex = Z2ZeroBiasfloat_str.rightJustified(8,QLatin1Char('0'));
    QString Z2ZeroBiasdataStr = Z2ZeroBiasfloat_hex.mid(6,2)+" "+Z2ZeroBiasfloat_hex.mid(4,2)+" "+Z2ZeroBiasfloat_hex.mid(2,2)+" "+Z2ZeroBiasfloat_hex.mid(0,2)+" ";
    int Z2ZeroBiasCheckSumInt = Z2ZeroBiasfloat_hex.mid(6,2).toInt(nullptr,16) + Z2ZeroBiasfloat_hex.mid(4,2).toInt(nullptr,16)+Z2ZeroBiasfloat_hex.mid(2,2).toInt(nullptr,16)+Z2ZeroBiasfloat_hex.mid(0,2).toInt(nullptr,16);

    QString X2GyroInstalErrorFloatStr = ui->lineEdit_76->text();
    double X2GyroInstalErrorf = X2GyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 X2GyroInstalErroruint32 = qRound64(X2GyroInstalErrorf);
    QString X2GyroInstalErrorfloat_str = QString::number(X2GyroInstalErroruint32,16);
    QString X2GyroInstalErrorfloat_hex = X2GyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString X2GyroInstalErrordataStr = X2GyroInstalErrorfloat_hex.mid(6,2)+" "+X2GyroInstalErrorfloat_hex.mid(4,2)+" "+X2GyroInstalErrorfloat_hex.mid(2,2)+" "+X2GyroInstalErrorfloat_hex.mid(0,2)+" ";
    int X2GyroInstalErrorCheckSumInt = X2GyroInstalErrorfloat_hex.mid(6,2).toInt(nullptr,16) + X2GyroInstalErrorfloat_hex.mid(4,2).toInt(nullptr,16)+X2GyroInstalErrorfloat_hex.mid(2,2).toInt(nullptr,16)+X2GyroInstalErrorfloat_hex.mid(0,2).toInt(nullptr,16);

    QString Y2GyroInstalErrorFloatStr = ui->lineEdit_78->text();
    double Y2GyroInstalErrorf = Y2GyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 Y2GyroInstalErroruint32 = qRound64(Y2GyroInstalErrorf);
    QString Y2GyroInstalErrorfloat_str = QString::number(Y2GyroInstalErroruint32,16);
    QString Y2GyroInstalErrorfloat_hex = Y2GyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString Y2GyroInstalErrordataStr = Y2GyroInstalErrorfloat_hex.mid(6,2)+" "+Y2GyroInstalErrorfloat_hex.mid(4,2)+" "+Y2GyroInstalErrorfloat_hex.mid(2,2)+" "+Y2GyroInstalErrorfloat_hex.mid(0,2)+" ";
    int Y2GyroInstalErrorCheckSumInt = Y2GyroInstalErrorfloat_hex.mid(6,2).toInt(nullptr,16) + Y2GyroInstalErrorfloat_hex.mid(4,2).toInt(nullptr,16)+Y2GyroInstalErrorfloat_hex.mid(2,2).toInt(nullptr,16)+Y2GyroInstalErrorfloat_hex.mid(0,2).toInt(nullptr,16);

    QString Z2GyroInstalErrorFloatStr = ui->lineEdit_77->text();
    double Z2GyroInstalErrorf = Z2GyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 Z2GyroInstalErroruint32 = qRound64(Z2GyroInstalErrorf);
    QString Z2GyroInstalErrorfloat_str = QString::number(Z2GyroInstalErroruint32,16);
    QString Z2GyroInstalErrorfloat_hex = Z2GyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString Z2GyroInstalErrordataStr = Z2GyroInstalErrorfloat_hex.mid(6,2)+" "+Z2GyroInstalErrorfloat_hex.mid(4,2)+" "+Z2GyroInstalErrorfloat_hex.mid(2,2)+" "+Z2GyroInstalErrorfloat_hex.mid(0,2)+" ";
    int Z2GyroInstalErrorCheckSumInt = Z2GyroInstalErrorfloat_hex.mid(6,2).toInt(nullptr,16) + Z2GyroInstalErrorfloat_hex.mid(4,2).toInt(nullptr,16)+Z2GyroInstalErrorfloat_hex.mid(2,2).toInt(nullptr,16)+Z2GyroInstalErrorfloat_hex.mid(0,2).toInt(nullptr,16);

    QString Z3GyroInstalErrorFloatStr = ui->lineEdit_79->text();
    double Z3GyroInstalErrorf = Z3GyroInstalErrorFloatStr.toDouble() * qPow(10,6);
    quint32 Z3GyroInstalErroruint32 = qRound64(Z3GyroInstalErrorf);
    QString Z3GyroInstalErrorfloat_str = QString::number(Z3GyroInstalErroruint32,16);
    QString Z3GyroInstalErrorfloat_hex = Z3GyroInstalErrorfloat_str.rightJustified(8,QLatin1Char('0'));
    QString Z3GyroInstalErrordataStr = Z3GyroInstalErrorfloat_hex.mid(6,2)+" "+Z3GyroInstalErrorfloat_hex.mid(4,2)+" "+Z3GyroInstalErrorfloat_hex.mid(2,2)+" "+Z3GyroInstalErrorfloat_hex.mid(0,2)+" ";
    int Z3GyroInstalErrorCheckSumInt = Z3GyroInstalErrorfloat_hex.mid(6,2).toInt(nullptr,16) + Z3GyroInstalErrorfloat_hex.mid(4,2).toInt(nullptr,16)+Z3GyroInstalErrorfloat_hex.mid(2,2).toInt(nullptr,16)+Z3GyroInstalErrorfloat_hex.mid(0,2).toInt(nullptr,16);


    int SdataCheckSum = XGyroScaleCheckSumInt +YGyroScaleCheckSumInt+ ZGyroScaleCheckSumInt+XZeroBiasCheckSumInt+ ;
    QString SdataCheckSumHexStr= QString::number(SdataCheckSum,16).right(2);


    QString  SdataStr= "EB 90 14 ";
     ...
     QString dateStr =current_date_time.toString("[yyyy-MM-dd hh:mm:ss]");
     QString dateTimeStr = dateStr + "\n";
     QString bookDataStr = tr("加速度计标定参数2：") + tr("X加速度计名义标度=")+QString::number(XGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计名义标度=")+ QString::number(YGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计名义标度=")+ QString::number(ZGyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" X加速度计序号=")+ QString::number(XZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计序号=")+ QString::number(YZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计序号=")+ QString::number(ZZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" X加速度计符号=")+ QString::number(XGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计符号=")+ QString::number(YGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计符号=")+ QString::number(ZGyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" X加速度计标度非对称性误差=")+ QString::number(X2GyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Y加速度计标度非对称性误差=")+ QString::number(Y2GyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" Z加速度计标度非对称性误差=")+ QString::number(Z2GyroScaleFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L1X=")+ QString::number(X2ZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L1Y=")+ QString::number(Y2ZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L1Z=")+ QString::number(Z2ZeroBiasFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L2X=")+ QString::number(X2GyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L2Y=")+ QString::number(Y2GyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 加标尺寸效应L2Z=")+ QString::number(Z2GyroInstalErrorFloatStr.toDouble(),'f',4)
                                                 + tr(" 温度系数=")+ QString::number(Z3GyroInstalErrorFloatStr.toDouble(),'f',4)+"\n";
     QString sendBookDataStr = dateTimeStr+bookDataStr;
     emit bookLogCMD(sendBookDataStr);
...
void CalibratParaDialog::on_pushButton_5_clicked()
{

    QByteArray Sdata;

    //DVL-X标度
    QString DVLXFloatStr = ui->lineEdit_30->text();
    double DVLXf = DVLXFloatStr.toDouble() * qPow(10,4);
    quint16 DVLXuint16 = qRound64(DVLXf);
    QString DVLXfloat_str = QString::number(DVLXuint16,16);
    QString DVLXfloat_hex = DVLXfloat_str.rightJustified(4,QLatin1Char('0'));
    QString DVLXdataStr = DVLXfloat_hex.mid(6,2)+" "+DVLXfloat_hex.mid(4,2)+" "+DVLXfloat_hex.mid(2,2)+" "+DVLXfloat_hex.mid(0,2)+" ";
    int DVLXCheckSumInt = DVLXfloat_hex.mid(6,2).toInt(nullptr,16) + DVLXfloat_hex.mid(4,2).toInt(nullptr,16)+DVLXfloat_hex.mid(2,2).toInt(nullptr,16)+DVLXfloat_hex.mid(0,2).toInt(nullptr,16);

    //DVL-Y标度
    QString DVLYFloatStr = ui->lineEdit_28->text();
    double DVLYf = DVLYFloatStr.toDouble() * qPow(10,4);
    quint16 DVLYuint16 = qRound64(DVLYf);
    QString DVLYfloat_str = QString::number(DVLYuint16,16);
    QString DVLYfloat_hex = DVLYfloat_str.rightJustified(4,QLatin1Char('0'));
    QString DVLYdataStr = DVLYfloat_hex.mid(6,2)+" "+DVLYfloat_hex.mid(4,2)+" "+DVLYfloat_hex.mid(2,2)+" "+DVLYfloat_hex.mid(0,2)+" ";
    int DVLYCheckSumInt = DVLYfloat_hex.mid(6,2).toInt(nullptr,16) + DVLYfloat_hex.mid(4,2).toInt(nullptr,16)+DVLYfloat_hex.mid(2,2).toInt(nullptr,16)+DVLYfloat_hex.mid(0,2).toInt(nullptr,16);

    //DVL-Z标度
    QString DVLZFloatStr = ui->lineEdit_29->text();
    double DVLZf = DVLZFloatStr.toDouble() * qPow(10,4);
    quint16 DVLZuint16 = qRound64(DVLZf);
    QString DVLZfloat_str = QString::number(DVLZuint16,16);
    QString DVLZfloat_hex = DVLZfloat_str.rightJustified(4,QLatin1Char('0'));
    QString DVLZdataStr = DVLZfloat_hex.mid(6,2)+" "+DVLZfloat_hex.mid(4,2)+" "+DVLZfloat_hex.mid(2,2)+" "+DVLZfloat_hex.mid(0,2)+" ";
    int DVLZCheckSumInt = DVLZfloat_hex.mid(6,2).toInt(nullptr,16) + DVLZfloat_hex.mid(4,2).toInt(nullptr,16)+DVLZfloat_hex.mid(2,2).toInt(nullptr,16)+DVLZfloat_hex.mid(0,2).toInt(nullptr,16);

    //校验和
    int SdataCheckSum = DVLXCheckSumInt +DVLYCheckSumInt + DVLZCheckSumInt+22;

    QString SdataCheckSumHexStr= QString::number(SdataCheckSum,16).right(2);

    QString  SdataStr= "EB 90 16 "+DVLXdataStr+DVLYdataStr+DVLZdataStr+SdataCheckSumHexStr;
     ...
     QString dateTimeStr = dateStr + "\n";
     QString bookDataStr;
     bookDataStr = tr("装订DVL标度：") + tr("DVL-X标度=")+ QString::number(DVLXFloatStr.toDouble(),'f',4)+tr(" DVL-Y标度=")+ QString::number(DVLYFloatStr.toDouble(),'f',4)+tr(" DVL-Z标度=")+ QString::number(DVLZFloatStr.toDouble(),'f',4)+"\n";
     QString sendBookDataStr = dateTimeStr+bookDataStr;
     emit bookLogCMD(sendBookDataStr);
