...
void LeverArmDialog::on_pushButton_clicked()
{
    ...
    QString  SdataStr= "EB 90 0C "+X1GPS1dataStr+Y1GPS1dataStr+Z1GPS1dataStr+X2GPS2dataStr+Y2GPS2dataStr+Z2GPS2dataStr+X3DOPPLERdataStr+Y3DOPPLERdataStr+Z3DOPPLERdataStr
     ...
     QString bookDataStr = tr("装订杆臂数据：") + tr("X1(GPS1)=")+ QString::number(X1GPS1FloatStr.toDouble(),'f',4)
                                                 + tr(" Y1(GPS1)=")+ QString::number(Y1GPS1FloatStr.toDouble(),'f',4)
                                                 + tr(" Z1(GPS1)=")+ QString::number(Z1GPS1FloatStr.toDouble(),'f',4)
                                                 + tr(" X2(GPS2)=")+ QString::number(X2GPS2FloatStr.toDouble(),'f',4)
                                                 + tr(" Y2(GPS2)=")+ QString::number(Y2GPS2FloatStr.toDouble(),'f',4)
                                                 + tr(" Z2(GPS2)=")+ QString::number(Z2GPS2FloatStr.toDouble(),'f',4)
                                                 + tr(" X3(DOPPLER)=")+ QString::number(X3DOPPLERFloatStr.toDouble(),'f',4)
                                                 + tr(" Y3(DOPPLER)=")+ QString::number(Y3DOPPLERFloatStr.toDouble(),'f',4)
                                                 + tr(" Z3(DOPPLER)=")+ QString::number(Z3DOPPLERFloatStr.toDouble(),'f',4)
                                                 + tr(" X4(LOG_EM)=")+ QString::number(X4LOG_EMFloatStr.toDouble(),'f',4)
                                                 + tr(" Y4(LOG_EM)=")+ QString::number(Y4LOG_EMFloatStr.toDouble(),'f',4)
                                                 + tr(" Z4(LOG_EM)=")+ QString::number(Z4LOG_EMFloatStr.toDouble(),'f',4)
                                                 + tr(" X5(MAIN_INS)=")+ QString::number(X5MAIN_INSFloatStr.toDouble(),'f',4)
                                                 + tr(" Y5(MAIN_INS)=")+ QString::number(Y5MAIN_INSFloatStr.toDouble(),'f',4)
                                                 + tr(" Z5(MAIN_INS)=")+ QString::number(Z5MAIN_INSFloatStr.toDouble(),'f',4)
                                                 + tr(" X6(ACC)=")+ QString::number(X6ACCFloatStr.toDouble(),'f',4)
                                                 + tr(" Y6(ACC)=")+ QString::number(Y6ACCFloatStr.toDouble(),'f',4)
                                                 + tr(" Z6(ACC)=")+ QString::number(Z6ACCFloatStr.toDouble(),'f',4)
                                                 +"\n";
